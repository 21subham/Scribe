...
export default function Homepage({
  ...
  return (
    <main className="flex-1 flex flex-col justify-center p-4 gap-3 sm:gap-4 text-center pb-20 ">
      ...
      <button
        className="flex text-center text-base justify-between gap-4 mx-auto w-72 max-w-full my-4 specialBtn px-4 py-2 rounded-xl"
        onClick={
      ...
      <p className="italic text-slate-400">Every word tells a story</p>
    </main>
  );
}
